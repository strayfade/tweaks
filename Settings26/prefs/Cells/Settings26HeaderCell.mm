...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	titleLabel.text = @"Settings26";
	titleLabel.font = [UIFont boldSystemFontOfSize:38.0];
	...
	versionLabel.font = [UIFont boldSystemFontOfSize:18.0];
	versionLabel.textColor = UIColor.secondaryLabelColor;
	versionLabel.textAlignment = NSTextAlignmentCenter;
	[self.contentView addSubview:versionLabel];

	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:kSettings26PrefsSuite];
	...
	[NSLayoutConstraint activateConstraints:@[
		...
		[versionLabel.topAnchor constraintEqualToAnchor:titleLabel.bottomAnchor constant:-6.0],

		[_toggle.topAnchor constraintEqualToAnchor:versionLabel.bottomAnchor constant:30.0],
		[_toggle.centerXAnchor constraintEqualToAnchor:self.contentView.centerXAnchor],
		[_toggle.bottomAnchor constraintEqualToAnchor:self.contentView.bottomAnchor constant:-14.0]
	]];
