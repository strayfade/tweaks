...
@interface settings26ListController : PSListController
- (void)promptRespring;
@end

@implementation settings26ListController

- (id)specifiers {
	if (_specifiers == nil) {
		_specifiers = [self loadSpecifiersFromPlistName:@"settings26" target:self];
	}
	return _specifiers;
}
