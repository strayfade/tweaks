#import "LSTextDeveloperCell.h"
#import <Preferences/PSSpecifier.h>

@interface LSTextDeveloperView : UIControl
...
@implementation LSTextDeveloperView {
...
@implementation LSTextDeveloperCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	LSTextDeveloperView *developerView = [LSTextDeveloperView new];
