#import "ShareClipboardHeaderCell.h"
#import <Preferences/PSSpecifier.h>
#import "../TintColors.h"

static NSString *const kShareClipboardPrefsSuite = @"com.strayfade.shareclipboard~prefs";

@implementation ShareClipboardHeaderCell {
	UISwitch *_toggle;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	titleLabel.text = @"ShareClipboard";
	...
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:kShareClipboardPrefsSuite];
