#import "ShareClipboardDeveloperCell.h"
#import <Preferences/PSSpecifier.h>

@interface ShareClipboardDeveloperView : UIControl
...
@implementation ShareClipboardDeveloperView {
...
@implementation ShareClipboardDeveloperCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	ShareClipboardDeveloperView *developerView = [ShareClipboardDeveloperView new];
