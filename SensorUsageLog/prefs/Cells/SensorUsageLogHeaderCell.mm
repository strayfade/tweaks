#import "SensorUsageLogHeaderCell.h"
#import <Preferences/PSSpecifier.h>
#import "../TintColors.h"

static NSString *const kSensorUsageLogPrefsSuite = @"com.strayfade.sensorusagelog~prefs";

@implementation SensorUsageLogHeaderCell {
	UISwitch *_toggle;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	titleLabel.text = @"SensorUsageLog";
	...
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:kSensorUsageLogPrefsSuite];
