#import "NetsocketHeaderCell.h"
#import <Preferences/PSSpecifier.h>
#import "../TintColors.h"

static NSString *const kNetsocketPrefsSuite = @"com.strayfade.netsocket~prefs";

@implementation NetsocketHeaderCell {
	UISwitch *_toggle;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:kNetsocketPrefsSuite];
