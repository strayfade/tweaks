#import "SplashTextDeveloperCell.h"
#import <Preferences/PSSpecifier.h>

@interface SplashTextDeveloperView : UIControl
...
@implementation SplashTextDeveloperView {
...
@implementation SplashTextDeveloperCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	SplashTextDeveloperView *developerView = [SplashTextDeveloperView new];
