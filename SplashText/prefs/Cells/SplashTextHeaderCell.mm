#import "SplashTextHeaderCell.h"
#import <Preferences/PSSpecifier.h>
#import "../TintColors.h"

static NSString *const kSplashTextPrefsSuite = @"com.strayfade.splashtext~prefs";

@implementation SplashTextHeaderCell {
	UISwitch *_toggle;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:kSplashTextPrefsSuite];
