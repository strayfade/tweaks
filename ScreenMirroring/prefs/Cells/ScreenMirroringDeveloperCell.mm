#import "ScreenMirroringDeveloperCell.h"
#import <Preferences/PSSpecifier.h>

@interface ScreenMirroringDeveloperView : UIControl
...
@implementation ScreenMirroringDeveloperView {
...
@implementation ScreenMirroringDeveloperCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	ScreenMirroringDeveloperView *developerView = [ScreenMirroringDeveloperView new];
