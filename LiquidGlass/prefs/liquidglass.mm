...
@interface liquidglassListController : PSListController
@end

@implementation liquidglassListController

- (id)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"liquidglass" target:self];
	}
	return _specifiers;
}
