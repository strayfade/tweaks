#import "LiquidGlassHeaderCell.h"
#import <Preferences/PSSpecifier.h>
#import "../TintColors.h"

static NSString *const kLiquidGlassPrefsSuite = @"com.strayfade.liquidglass~prefs";

@implementation LiquidGlassHeaderCell {
	UISwitch *_toggle;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:kLiquidGlassPrefsSuite];
