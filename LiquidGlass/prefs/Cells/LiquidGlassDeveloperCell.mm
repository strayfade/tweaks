#import "LiquidGlassDeveloperCell.h"
#import <Preferences/PSSpecifier.h>

@interface LiquidGlassDeveloperView : UIControl
...
@implementation LiquidGlassDeveloperView {
...
@implementation LiquidGlassDeveloperCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
	...
	LiquidGlassDeveloperView *developerView = [LiquidGlassDeveloperView new];
